...
# Ensures taskbar pin + correct icon
import ctypes
ctypes.windll.shell32.SetCurrentProcessExplicitAppUserModelID("OTM.Onboarding.Tool")

# Load icon for script + packaged exe
import sys, os
...
icon_file = os.path.join(base_path, "OTM.ico")
...
root.title("Onboarding Template Maker V2")
